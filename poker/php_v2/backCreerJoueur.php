...
<html lang="fr">
    ...
    else
    {
        ...
        $requete = $bdd->prepare('INSERT INTO utilisateur(pseudo_util, mdp_util, jeton_util, acces_util, id_bar) VALUES (:pseudo, :mdp, 0, 1, :bar)');
        $requete->execute([':pseudo'=>$pseudo, ':mdp'=>$mdp, ':bar'=>$_SESSION['bar']]);
