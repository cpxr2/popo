...
--
-- Structure de la table `joueur222`
--

CREATE TABLE `joueur22` (
...
--
-- Contenu de la table `joueur22`
--

INSERT INTO `joueur22` (`id_jou`, `nom_jou`, `mdp_jou`, `acces_jou`, `id_admin`, `jeton_jou`) VALUES
...
--
-- Index pour la table `joueur22`
--
ALTER TABLE `joueur22`
...
--
-- AUTO_INCREMENT pour la table `joueur22`
--
ALTER TABLE `joueur22`
